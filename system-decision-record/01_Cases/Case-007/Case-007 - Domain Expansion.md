...
---
 ...
 TEMPORARY IMAGE (NFHL DOWN TODAY)
...
### [[EXP-005 - Run a Model with Domain Developed from Reach Divide]] on reach 3250307
...
According to [[DR-012 - What Strategy to be used for Determining if Domain Should be Expanded#ALT-B - Informed by Elevation]], this model would trigger [[ISU-009 - Water pooling on model edge]].  The black area is very limited in extent as you move to the west (downstream).  ALT-B would therefore lead to an very large domain for this reach.  Such a large reach would lead to inefficient modeling.
